...
#define TC2XF1  5
#define TC2XF0  4
// AFCKS (bit 2): automatic frequency-check status/control per datasheet v1.0.5
#define AFCKS   2
#define TC2XS1  1
#define TC2XS0  0
...
// NOTE: OC3A/OC3B (bits 7/6, AVR TIFR1 convention) are RESERVED on this chip.
// LGT8FX8P datasheet v1.0.5: TIFR3 = ICF3(5) OCF3C(3) OCF3B(2) OCF3A(1) TOV3(0).
#define ICF3    5
#define OCF3C   3
#define OCF3B   2
#define OCF3A   1
...
// Bits of CLKPR (datasheet names: CKOE1/CKOE0, WCE)
#define WCE     7
#define CKOE1   6
#define CKOE0   5
// Backward-compatible aliases used by older sketches
#define CLKOE1  CKOE1
#define CLKOE0  CKOE0
#define CLKOE   CKOE0
...
#define PRWDT   5
#define PRTIM3  3
#define PRTC3   PRTIM3  // backward-compatible alias
#define PREFL   2
#define PRPCI   1
