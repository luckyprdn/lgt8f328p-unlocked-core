...
// Optional LGT8F memory profiles can override the Arduino defaults without
// breaking the legacy SERIAL_RX_BUFFER_SIZE board option used by ArduinoISP.
#if defined(LGT_SERIAL_TX_BUFFER_SIZE)
  #undef SERIAL_TX_BUFFER_SIZE
  #define SERIAL_TX_BUFFER_SIZE LGT_SERIAL_TX_BUFFER_SIZE
#endif
#if defined(LGT_SERIAL_RX_BUFFER_SIZE)
  #undef SERIAL_RX_BUFFER_SIZE
  #define SERIAL_RX_BUFFER_SIZE LGT_SERIAL_RX_BUFFER_SIZE
#endif
